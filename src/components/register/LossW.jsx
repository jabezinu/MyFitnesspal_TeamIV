...
const LossW = () => {
  ...
  const handleNext = () => {
    if (!weeklyGoal) {
      alert("Please select a weekly goal before continuing.");
      return;
    }
  ...
  const goals = [
    { label: "0.5 lbs/week", value: "0.5 lbs/week" },
    { label: "1 lbs/week", value: "1 lbs/week" },
    { label: "1.5 lbs/week", value: "1.5 lbs/week" },
    { label: "2 lbs/week", value: "2 lbs/week" },
  ];
        ...
        <div className="grid grid-cols-2 gap-4">
          {goals.map((goal) => (
            <motion.div
              ...
              className={`cursor-pointer p-5 rounded-xl shadow-md border transition-all text-center ${
