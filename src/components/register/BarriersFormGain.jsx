...
const BarriersFormGain = () => {
  ...
  const barriers = [
    "Struggled with eating enough calories",
    "Lack of time to cook meals",
    "Difficulty following meal plan",
    "Challenges from social events",
  ];
    ...
    >
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-lg p-8">
        ...
        <h2 className="text-lg font-semibold text-gray-900 mb-2 text-center">
          What challenges make gaining weight harder?
        </h2>
...
export default BarriersFormGain;
