...
const BarriersFormMaintain = () => {
  ...
  const barriers = [
    "Struggling to maintain portion sizes",
    "Skipping meals or inconsistent eating",
    "Difficulty staying active regularly",
    "Temptations at social gatherings",
  ];

  useEffect(() => {
    if (!firstName || !lastName || goal !== "Maintain Weight") {
    ...
    >
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-lg p-8">
        ...
        <h2 className="text-lg font-semibold text-gray-900 mb-2 text-center">
          What challenges do you face maintaining your weight?
        </h2>
...
export default BarriersFormMaintain;
