...
export const FoodManagementPage = () => {
  ...
  e.preventDefault();
  const calories = Number.parseInt(newFood.calories);
  const protein = Number.parseInt(newFood.protein);
  const carbs = Number.parseInt(newFood.carbs);
  const fat = Number.parseInt(newFood.fat);
